...
<a class="nav-link" href="/dashboard" style="font-size:150%; position: fixed; bottom: 20px; right: 20px; background-color: #007bff; color: white; padding: 10px 20px; border-radius: 5px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); text-decoration: none;">Trang Admin</a>
@else
            @endif
    <!-- Spinner Start -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="my-orders" class="nav-item nav-link">Đơn Hàng</a>
                </div>
                <div class="d-none d-lg-flex ms-2">
                    ...
                    <a class="btn-sm-square bg-white rounded-circle ms-5" href="" style="margin-right: 70px">
                        ...
                        @csrf
                        <button type="submit" class="btn btn-outline-info" style="width: 200%">{{ session('user')->name }}<br>Đăng xuất</button>
                        </form>
                        @else
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        ...
                        <div class="col-12 text-center">
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="/home/products">Browse More Products</a>
                        </div>
                    </div>
                </div>
            </div>
