            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('orders.updateStatus', [$order->id, 'shipping']) }}" method="POST" style="display: inline-block;">
                            @csrf
                            <button type="submit" class="btn btn-warning">Đang giao hàng</button>
                        </form>
                        <form action="{{ route('orders.updateStatus', [$order->id, 'delivered']) }}" method="POST" style="display: inline-block;">
                            @csrf
